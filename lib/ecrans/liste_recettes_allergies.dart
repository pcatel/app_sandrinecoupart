...
class ListeRecettesAllergies extends StatefulWidget {
  ...
  const ListeRecettesAllergies({
    Key? key,
    required this.idAllergie,
    required this.nomAllergie,
  }) : super(key: key);

  @override
  ListeRecettesAllergiesState createState() => ListeRecettesAllergiesState();
}

class ListeRecettesAllergiesState extends State<ListeRecettesAllergies> {
      ...
      width:double.infinity,
                child: Column(
                    children: [
                      ...
                      Text(
                        'Recettes sans ${widget.nomAllergie}',
